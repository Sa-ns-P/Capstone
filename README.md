...
<img align = "center" src = '[https://latex.codecogs.com/svg.image?log(response\_time_{ij})=\beta_0&plus;\beta_{0i}&plus;\beta_1\times\mathbb{1}(BirthGender="Female")&plus;\beta_2\times\mathbb{1}(Race="White")&plus;...&plus;\beta_7\times\mathbb{1}(Race=="Prefer\;not\;to;[answer")&plus;\beta_8\times&space;Age&plus;\beta_9\times\mathbb{1}(Movement="Approach")&plus;\beta_{10}\times\mathbb{1}(Morality="Moral")&plus;\beta_{11}\times\mathbb{1}(Morality="Immoral")&plus;\beta_{12}\times\mathbb{1}(Movement="Approach")\times\mathbb{1}(Morality="Moral")&plus;\beta_{13}(Movement="Approach")\times\mathbb{1}("Morality="Immoral")](https://latex.codecogs.com/svg.image?\inline&space;\small&space;&space;log(response\;time_{ij})=\beta_0&plus;\beta_{0i}&plus;\beta_1\times{1\!\!1}(BirthGender="Female")&plus;\beta_2\times{1\!\!1}(Race="White")&plus;...&plus;\beta_7\times{1\!\!1}(Race=="Prefer\;not\;to\;answer")&plus;\beta_8\times&space;Age&plus;\beta_9\times{1\!\!1}(Movement="Approach")&plus;\beta_{10}\times{1\!\!1}(Morality="Moral")&plus;\beta_{11}\times{1\!\!1}(Morality="Immoral")&plus;\beta_{12}\times{1\!\!1}(Movement="Approach")\times{1\!\!1}(Morality="Moral")&plus;\beta_{13}\times{1\!\!1}(Movement="Approach")\times{1\!\!1}("Morality="Immoral")'>
____
